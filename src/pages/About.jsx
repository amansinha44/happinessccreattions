...
import { Quote, Star, Youtube, Instagram, Compass, Gem, Lightbulb } from 'lucide-react';
...
const About = () => {
  return (
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden pt-24 pb-20">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start mb-24">
          ...
          <div className="relative group animate-fade-in-up">
            ...
            <div className="relative bg-[#1e293b] rounded-[2rem] overflow-hidden border border-white/10 h-[600px]">
              {/* PLACEHOLDER IMAGE - Replace src with Amit Gupta's actual photo */}
              <img 
          ...
          <div className="space-y-8 animate-fade-in-up delay-200">
            ...
            <p className="text-gray-400 italic mt-4">
              Thousands of clients follow his guidance, testifying to the transformative power of his readings.
            </p>
      ...
      {/* Internal Style for float animations (Reuse if needed) */}
      <style>{`
